class CL_ISH_STANDARD_OBJECT_ITAB definition
  public
  inheriting from CL_ISH_STANDARD_ITAB
  create protected .

public section.
*"* public components of class CL_ISH_STANDARD_OBJECT_ITAB
*"* do not include other source files here!!!

  constants CO_OTYPE_STANDARD_OBJECT_ITAB type ISH_OBJECT_TYPE value 13415. "#EC NOTEXT
  data GT_OBJECT type ISH_T_OBJECT read-only .
  ...
  class-methods CREATE
    ...
    returning
      value(RR_INSTANCE) type ref to CL_ISH_STANDARD_OBJECT_ITAB .
  ...
  methods IF_ISH_IDENTIFY_OBJECT~IS_INHERITED_FROM
    redefinition .
protected section.
*"* protected components of class CL_ISH_STANDARD_OBJECT_ITAB
*"* do not include other source files here!!!
  ...
  methods IS_VALUE_VALID
    redefinition .
private section.
*"* private components of class CL_ISH_STANDARD_OBJECT_ITAB
*"* do not include other source files here!!!
ENDCLASS.



CLASS CL_ISH_STANDARD_OBJECT_ITAB IMPLEMENTATION.
...
METHOD create.
  ...
  DATA: lr_instance  TYPE REF TO cl_ish_standard_object_itab,
...
METHOD if_ish_identify_object~get_type.
  ...
  e_object_type = co_otype_standard_object_itab.
...
METHOD if_ish_identify_object~is_inherited_from.
  ...
  IF i_object_type = co_otype_standard_object_itab.
