...
* Generated by SAP_LOCAL_DOWNPORT_ASSISTANT Version 7.19 on 05.02.2019 with option ALL

* The individual coding starts at 'FORM update_01.' ( line 3.489 )
...
FORM update_02. " DOCU TXISHMED_N1ORGPAR_N1MEBHCO ( DE , source: EV8 )
  CALL METHOD lcl_wb=>create_other_docu     "#EC *
    EXPORTING
      i_devclass  = 'NMED_ME'
      i_docname   = 'TXISHMED_N1ORGPAR_N1MEBHCO'
      i_langu     = 'D'
      i_line      =:'U1 Medikation: Anhängen von kontinuierlichen Infusionen',                                     "#EC NOTEXT
                    'U1 DEFINITION',                                                                               "#EC NOTEXT
                    '*  Mit diesem Parameter können Sie festlegen, dass das System eine neue',                     "#EC NOTEXT
                    '   Infusion  für die Ereignisse der laufenden und abgehängten',                               "#EC NOTEXT
                    '   kontinuierlichen Infusionen hinzufügt.',                                                   "#EC NOTEXT
                    '*  Sie pflegen diesen Parameter, um das Programm',                                            "#EC NOTEXT
                    '=   <DS:RE.RN1ME_EMAR_QUICK_INF_CHANGE>RN1ME_EMAR_QUICK_INF_CHANGE</>',                       "#EC NOTEXT
                    '   ausführen zu können.',                                                                     "#EC NOTEXT
                    '*  Das System prüft den Parameterwert in der folgenden Reihenfolge:',                         "#EC NOTEXT
                    'B1 Dokumentierende pflegerische OE',                                                          "#EC NOTEXT
                    'B1 Dokumentierende fachliche OE',                                                             "#EC NOTEXT
                    'B1 Alle Organisationseinheiten (*)',                                                          "#EC NOTEXT
                    space.
ENDFORM.

FORM update_03. " DOCU TXISHMED_N1ORGPAR_N1MEBHOT ( DE , source: EV8 )
  CALL METHOD lcl_wb=>create_other_docu     "#EC *
    EXPORTING
      i_devclass  = 'NMED_ME'
      i_docname   = 'TXISHMED_N1ORGPAR_N1MEBHOT'
      i_langu     = 'D'
      i_line      =:'U1 Medikation: Anhängen von Einmalgaben und interm. Infusionen',                              "#EC NOTEXT
                    'U1 DEFINITION',                                                                               "#EC NOTEXT
                    '*  Mit diesem Parameter können Sie festlegen, dass das System eine neue',                     "#EC NOTEXT
                    '   Infusion für die Ereignisse der laufenden oder abgehängten Einmalgaben',                   "#EC NOTEXT
                    '   und intermittierenden Infusionen hinzufügt.',                                              "#EC NOTEXT
                    '*  Sie pflegen diesen Parameter, um das Programm',                                            "#EC NOTEXT
                    '=   <DS:RE.RN1ME_EMAR_QUICK_INF_CHANGE>RN1ME_EMAR_QUICK_INF_CHANGE</>',                       "#EC NOTEXT
                    '   ausführen zu können.',                                                                     "#EC NOTEXT
                    '*  Das System prüft den Parameterwert in der folgenden Reihenfolge:',                         "#EC NOTEXT
...
FORM update_04. " DOCU TXISHMED_N1ORGPAR_N1MEFLRT ( DE , source: EV8 )
  CALL METHOD lcl_wb=>create_other_docu     "#EC *
    EXPORTING
      i_devclass  = 'NMED_ME'
      i_docname   = 'TXISHMED_N1ORGPAR_N1MEFLRT'
      i_langu     = 'D'
      i_line      =:'*  Medikation: Dokumentation der Ratentypen im eMAR-Bereich',                                 "#EC NOTEXT
                    'U1 DEFINITION',                                                                               "#EC NOTEXT
                    '*  Mit diesem Parameter können Sie den Bearbeitungsbereich zum',                              "#EC NOTEXT
                    '   Dokumentieren von Raten ein- bzw. ausblenden.',                                            "#EC NOTEXT
                    '*  Sie können die folgenden Funktionen verwenden:',                                           "#EC NOTEXT
                    'B1 Drop-Down-Liste mit Flussrate, Bolus und Pause',                                           "#EC NOTEXT
                    'B1 Eingabefelder für Flussrate, Datum und Uhrzeit',                                           "#EC NOTEXT
                    'B1 Eingabefeld für die Flussrateneinheit',                                                    "#EC NOTEXT
                    'B1 Drucktaste zum Eintragen von Daten ins System',                                            "#EC NOTEXT
                    '*  Der Parameter gilt für alle Organisationseinheiten, welche die',                           "#EC NOTEXT
                    '   Arzneimittelverabreichungen auf der Registerkarte <ZK>eMAR</>',                            "#EC NOTEXT
                    '   dokumentieren.',                                                                           "#EC NOTEXT
                    '*',                                                                                           "#EC NOTEXT
                    '*  <ZH>Beachten Sie, dass der Bearbeitungsbereich nicht bei der',                             "#EC NOTEXT
                    '   Verabreichung von Notfall-Ereignissen angezeigt wird.</>',                                 "#EC NOTEXT
                    '*',                                                                                           "#EC NOTEXT
                    '*  Das System prüft den Parameterwert in der folgenden Reihenfolge',                          "#EC NOTEXT
                    'B1 Dokumentierende pflegerische OE',                                                          "#EC NOTEXT
                    'B1 Dokumentierende fachliche OE',                                                             "#EC NOTEXT
                    'B1 Alle Organisationseinheiten (*)',                                                          "#EC NOTEXT
                    '*',                                                                                           "#EC NOTEXT
                    '*  VERWENDUNG',                                                                               "#EC NOTEXT
                    '*  Mögliche Parameterwerte:',                                                                 "#EC NOTEXT
                    'B1 <ZH>'' '' :  eMAR Bearbeitungsbereich ausblenden </>',                                     "#EC NOTEXT
                    '*  Wenn Sie diesen Wert setzen, verhält sich das System wie folgt:',                          "#EC NOTEXT
                    'B2 Es zeigt die Drucktasten für Flussrate, Bolus und Pause an.',                              "#EC NOTEXT
                    'B2 Es zeigt den eMAR Bearbeitungsbereich nicht an.',                                          "#EC NOTEXT
                    'B2 Es zeigt die Drucktaste <ZH>Alle Infusionen anhängen</> nicht an.',                        "#EC NOTEXT
                    'B1 <ZH>X :  eMAR Bearbeitungsbereich einblenden</>',                                          "#EC NOTEXT
                    '*  Wenn Sie diesen Wert setzen, verhält sich das System wie folgt:',                          "#EC NOTEXT
                    'B2 Es zeigt die Drucktasten für Flussrate, Bolus und Pause nicht an.',                        "#EC NOTEXT
                    'B2 Es zeigt den eMAR Bearbeitungsbereich an.',                                                "#EC NOTEXT
                    'B2 Es zeigt die Drucktaste <ZH>Alle Infusionen anhängen</> an.',                              "#EC NOTEXT
                    'B2',                                                                                          "#EC NOTEXT
                    '*',                                                                                           "#EC NOTEXT
                    '*',                                                                                           "#EC NOTEXT
                    space.
...
FORM update.
  ...
  PERFORM update_02. " DOCU TXISHMED_N1ORGPAR_N1MEBHCO ( DE , source: EV8 )
  PERFORM update_03. " DOCU TXISHMED_N1ORGPAR_N1MEBHOT ( DE , source: EV8 )
  PERFORM update_04. " DOCU TXISHMED_N1ORGPAR_N1MEFLRT ( DE , source: EV8 )
