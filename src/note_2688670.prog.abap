...
* Generated by SAP_LOCAL_DOWNPORT_ASSISTANT Version 7.06 on 20.09.2018 with option ALL

* The individual coding starts at 'FORM update_01.' ( line 3.952 )
...
FORM update_01. " TRAN N1TC_DELEGATE ( DE , source: EV8 )

  CALL METHOD lcl_wb=>create_logical_object "#EC *
    EXPORTING
      i_object     = 'TRAN'
      i_obj_name   = 'N1TC_DELEGATE'
      i_devclass   = 'N1BASE'
      i_langu      = 'D'
      i_masterlang = 'D'
    EXCEPTIONS
  ...
  CLEAR ls_tstc.
  ls_tstc-tcode     = 'N1TC_DELEGATE'.                                                              "#EC NOTEXT
  ls_tstc-pgmna     = 'SAPLN1TC_DIALOG'.                                                            "#EC NOTEXT
  ls_tstc-dypno     = '0050'.                                                                       "#EC NOTEXT
  ...
  CLEAR ls_tstct.
  ls_tstct-sprsl     = 'D'.                                                                         "#EC NOTEXT
  ls_tstct-tcode     = 'N1TC_DELEGATE'.                                                             "#EC NOTEXT
  ls_tstct-ttext     = 'Delegation des Behandlungsauftrags'.                                        "#EC NOTEXT
  ...
  CLEAR ls_tstca.
  ls_tstca-tcode     = 'N1TC_DELEGATE'.                                                             "#EC NOTEXT
  ls_tstca-objct     = 'N_EINR_TCO'.                                                                "#EC NOTEXT
  ls_tstca-field     = 'N_EINRI'.                                                                   "#EC NOTEXT
  ...
  ls_tstca-value     = 'N1TC_DELEGATE'.                                                             "#EC NOTEXT
  APPEND ls_tstca TO lt_tstca.
  ...
  CLEAR ls_tstcc.
  ls_tstcc-tcode         = 'N1TC_DELEGATE'.                                                         "#EC NOTEXT
  ...
  DATA: ls_usobt TYPE usobt, lt_usobt TYPE TABLE OF usobt.

  CLEAR ls_usobt.
  ls_usobt-name         = 'N1TC_DELEGATE'.                                                          "#EC NOTEXT
  ls_usobt-type         = 'TR'.                                                                     "#EC NOTEXT
  ls_usobt-object       = 'N_EINR_TCO'.                                                             "#EC NOTEXT
  ls_usobt-field        = 'N_EINRI'.                                                                "#EC NOTEXT
  ls_usobt-low          = '$EINRI'.                                                                 "#EC NOTEXT
  ...
  ls_usobt-type         = 'TR'.                                                                     "#EC NOTEXT
  ls_usobt-object       = 'N_EINR_TCO'.                                                             "#EC NOTEXT
  ls_usobt-field        = 'TCD'.                                                                    "#EC NOTEXT
  ls_usobt-low          = 'N1TC_DELEGATE'.                                                          "#EC NOTEXT
  APPEND ls_usobt TO lt_usobt.

  CLEAR ls_usobt.
  ls_usobt-name         = 'N1TC_DELEGATE'.                                                          "#EC NOTEXT
  ls_usobt-type         = 'TR'.                                                                     "#EC NOTEXT
  ls_usobt-object       = 'N_PATI_SRC'.                                                             "#EC NOTEXT
  ls_usobt-field        = 'N_EINRI'.                                                                "#EC NOTEXT
  ls_usobt-low          = '$EINRI'.                                                                 "#EC NOTEXT
  APPEND ls_usobt TO lt_usobt.
  ...
  CLEAR ls_usobx.
  ls_usobx-name         = 'N1TC_DELEGATE'.                                                          "#EC NOTEXT
  ls_usobx-type         = 'TR'.                                                                     "#EC NOTEXT
  ls_usobx-object       = 'B_BUP_PCPT'.                                                             "#EC NOTEXT
  ...
  ls_usobx-name         = 'N1TC_DELEGATE'.                                                          "#EC NOTEXT
  ls_usobx-type         = 'TR'.                                                                     "#EC NOTEXT
  ls_usobx-object       = 'N_2TBS'.                                                                 "#EC NOTEXT
  ...
  ls_usobx-name         = 'N1TC_DELEGATE'.                                                          "#EC NOTEXT
  ls_usobx-type         = 'TR'.                                                                     "#EC NOTEXT
  ls_usobx-object       = 'N_EINR_TCO'.                                                             "#EC NOTEXT
  ls_usobx-okflag       = 'Y'.                                                                      "#EC NOTEXT
  APPEND ls_usobx TO lt_usobx.

  CLEAR ls_usobx.
  ls_usobx-name         = 'N1TC_DELEGATE'.                                                          "#EC NOTEXT
  ls_usobx-type         = 'TR'.                                                                     "#EC NOTEXT
  ls_usobx-object       = 'N_FALL_DIS'.                                                             "#EC NOTEXT
  ls_usobx-okflag       = 'X'.                                                                      "#EC NOTEXT
  APPEND ls_usobx TO lt_usobx.
  ...
  ls_usobx-name         = 'N1TC_DELEGATE'.                                                          "#EC NOTEXT
  ls_usobx-type         = 'TR'.                                                                     "#EC NOTEXT
  ls_usobx-object       = 'N_FALL_FNR'.                                                             "#EC NOTEXT
  ls_usobx-okflag       = 'X'.                                                                      "#EC NOTEXT
  APPEND ls_usobx TO lt_usobx.
  ...
  ls_usobx-name         = 'N1TC_DELEGATE'.                                                          "#EC NOTEXT
  ls_usobx-type         = 'TR'.                                                                     "#EC NOTEXT
  ls_usobx-object       = 'N_FALL_SRC'.                                                             "#EC NOTEXT
  ls_usobx-okflag       = 'X'.                                                                      "#EC NOTEXT
  APPEND ls_usobx TO lt_usobx.
  ...
  ls_usobx-name         = 'N1TC_DELEGATE'.                                                          "#EC NOTEXT
  ls_usobx-type         = 'TR'.                                                                     "#EC NOTEXT
  ls_usobx-object       = 'N_PATI_AKT'.                                                             "#EC NOTEXT
  ls_usobx-okflag       = 'X'.                                                                      "#EC NOTEXT
  APPEND ls_usobx TO lt_usobx.
  ...
  ls_usobx-name         = 'N1TC_DELEGATE'.                                                          "#EC NOTEXT
  ls_usobx-type         = 'TR'.                                                                     "#EC NOTEXT
  ls_usobx-object       = 'N_PATI_SRC'.                                                             "#EC NOTEXT
  ls_usobx-okflag       = 'Y'.                                                                      "#EC NOTEXT
  APPEND ls_usobx TO lt_usobx.
  ...
  ls_usobx-name         = 'N1TC_DELEGATE'.                                                          "#EC NOTEXT
  ls_usobx-type         = 'TR'.                                                                     "#EC NOTEXT
  ls_usobx-object       = 'N_PS_ORIG'.                                                              "#EC NOTEXT
  ls_usobx-okflag       = 'U'.                                                                      "#EC NOTEXT
  APPEND ls_usobx TO lt_usobx.
  ...
  ls_usobx-name         = 'N1TC_DELEGATE'.                                                          "#EC NOTEXT
  ls_usobx-type         = 'TR'.                                                                     "#EC NOTEXT
  ls_usobx-object       = 'N_PS_PSEUD'.                                                             "#EC NOTEXT
  ls_usobx-okflag       = 'X'.                                                                      "#EC NOTEXT
  APPEND ls_usobx TO lt_usobx.
  ...
  ls_usobx-name         = 'N1TC_DELEGATE'.                                                          "#EC NOTEXT
  ls_usobx-type         = 'TR'.                                                                     "#EC NOTEXT
  ls_usobx-object       = 'N_TC_DG'.                                                                "#EC NOTEXT
  ls_usobx-okflag       = 'X'.                                                                      "#EC NOTEXT
  APPEND ls_usobx TO lt_usobx.
  ...
  ls_usobx-name         = 'N1TC_DELEGATE'.                                                          "#EC NOTEXT
  ls_usobx-type         = 'TR'.                                                                     "#EC NOTEXT
  ls_usobx-object       = 'S_ALV_LAYO'.                                                             "#EC NOTEXT
  ls_usobx-okflag       = 'X'.                                                                      "#EC NOTEXT
  APPEND ls_usobx TO lt_usobx.
  ...
  ls_usobx-name         = 'N1TC_DELEGATE'.                                                          "#EC NOTEXT
  ls_usobx-type         = 'TR'.                                                                     "#EC NOTEXT
  ls_usobx-object       = 'S_ALV_LAYR'.                                                             "#EC NOTEXT
  ls_usobx-okflag       = 'U'.                                                                      "#EC NOTEXT
  APPEND ls_usobx TO lt_usobx.
  ...
  ls_usobx-name         = 'N1TC_DELEGATE'.                                                          "#EC NOTEXT
  ls_usobx-type         = 'TR'.                                                                     "#EC NOTEXT
  ls_usobx-object       = 'S_DATASET'.                                                              "#EC NOTEXT
  ls_usobx-okflag       = 'X'.                                                                      "#EC NOTEXT
  APPEND ls_usobx TO lt_usobx.
  ...
  ls_usobx-name         = 'N1TC_DELEGATE'.                                                          "#EC NOTEXT
  ls_usobx-type         = 'TR'.                                                                     "#EC NOTEXT
  ls_usobx-object       = 'S_DEVELOP'.                                                              "#EC NOTEXT
  ls_usobx-okflag       = 'X'.                                                                      "#EC NOTEXT
  APPEND ls_usobx TO lt_usobx.
  ...
  ls_usobx-name         = 'N1TC_DELEGATE'.                                                          "#EC NOTEXT
  ls_usobx-type         = 'TR'.                                                                     "#EC NOTEXT
  ls_usobx-object       = 'S_RFC'.                                                                  "#EC NOTEXT
  ls_usobx-okflag       = 'X'.                                                                      "#EC NOTEXT
  APPEND ls_usobx TO lt_usobx.
  ...
  ls_usobx-name         = 'N1TC_DELEGATE'.                                                          "#EC NOTEXT
  ls_usobx-type         = 'TR'.                                                                     "#EC NOTEXT
  ls_usobx-object       = 'S_TRANSLAT'.                                                             "#EC NOTEXT
  ls_usobx-okflag       = 'X'.                                                                      "#EC NOTEXT
  APPEND ls_usobx TO lt_usobx.
  ...
  CLEAR ls_usob_sm.
  ls_usob_sm-name           = 'N1TC_DELEGATE'.                                                      "#EC NOTEXT
...
FORM update.
  ...
  PERFORM update_01. " TRAN N1TC_DELEGATE ( DE , source: EV8 )
