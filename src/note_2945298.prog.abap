...
* Generated by SAP_LOCAL_DOWNPORT_ASSISTANT Version 7.57 on 08.07.2020 with option ALL

* The individual coding starts at 'FORM update_01.' ( line 4.975 )
...
*      APPEND INITIAL LINE TO lt_textpool ASSIGNING <ls_textpool>.
    ...
    TRY.                                                            ">=SAPBASIS640
        "clean up locks, shall happen in RPY_TEXTELEMENTS_INSERT    ">=SAPBASIS640
        CALL FUNCTION 'DEQUEUE_EABAPTEXTE'                          ">=SAPBASIS640
          EXPORTING                                                 ">=SAPBASIS640
            _scope         = '1'                                    ">=SAPBASIS640
            mode_s010t     = 'X'                                    ">=SAPBASIS640
            repid          = i_progname.                            ">=SAPBASIS640
      CATCH cx_sy_dyn_call_illegal_func.                            ">=SAPBASIS640
    ENDTRY.                                                         ">=SAPBASIS640
...
FORM update_02. " REPT SAPL0N1TC ( DE , source: EV8 )
...
FORM update_03_0100. " TOBJ V_TN1TC_GLOB_SET ( DE EV8 )
  ...
  ls_rpy_dyfatc-text             = 'SicherhSt.______________________________'.                      "#EC NOTEXT
  ls_rpy_dyfatc-line             = '001'.                                                           "#EC NOTEXT
...
FORM update_03. " TOBJ V_TN1TC_GLOB_SETV ( DE , source: EV8 )
...
FORM update_04. " TABU TVIMF ( DE , source: EV8 )
...
FORM genview.
  ...
  PERFORM update_03. " TOBJ V_TN1TC_GLOB_SETV ( DE , source: EV8 )
ENDFORM.

FORM update.

  gv_master_languages   = 'D'.  "#EC NOTEXT
  gv_objects_with_snote_check = 'FUGR,REPT'.  "#EC NOTEXT

  PERFORM update_01. " FUGR 0N1TC ( DE , source: EV8 )
  PERFORM update_02. " REPT SAPL0N1TC ( DE , source: EV8 )
  PERFORM update_03. " TOBJ V_TN1TC_GLOB_SETV ( DE , source: EV8 )
  PERFORM update_04. " TABU TVIMF ( DE , source: EV8 )
