*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_V_TN1TC_CATEGORY
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_V_TN1TC_CATEGORY    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_V_TN1TC_CATEGORY'
         EXPORTING
              FCODE          = READ
...
EXTRACT = V_TN1TC_CATEGORY_EXTRACT
TOTAL = V_TN1TC_CATEGORY_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_V_TN1TC_CATEGORY'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_V_TN1TC_CATEGORY-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = V_TN1TC_CATEGORY_EXTRACT
TOTAL = V_TN1TC_CATEGORY_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_V_TN1TC_CATEGORY-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_V_TN1TC_CATEGORY'
...
TOTAL = V_TN1TC_CATEGORY_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_V_TN1TC_CATEGORY-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_V_TN1TC_CATEGORY-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_V_TN1TC_CATEGORY'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_V_TN1TC_CATEGORY-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = V_TN1TC_CATEGORY_EXTRACT
TOTAL = V_TN1TC_CATEGORY_TOTAL
