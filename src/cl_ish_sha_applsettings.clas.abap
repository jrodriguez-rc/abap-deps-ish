class CL_ISH_SHA_APPLSETTINGS definition
  public
...
*"* public components of class CL_ISH_SHA_APPLSETTINGS
*"* do not include other source files here!!!
public section.

  constants AREA_NAME type SHM_AREA_NAME value 'CL_ISH_SHA_APPLSETTINGS'. "#EC NOTEXT
  data ROOT type ref to CL_ISH_AS_LOADER read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to CL_ISH_SHA_APPLSETTINGS
    raising
      CX_SHM_INCONSISTENT
  ...
  methods SET_ROOT
    importing
      !ROOT type ref to CL_ISH_AS_LOADER
    raising
  ...
  methods GET_ROOT
    redefinition .
protected section.
*"* protected components of class CL_ISH_SHA_APPLSETTINGS
*"* do not include other source files here!!!
private section.
*"* private components of class CL_ISH_SHA_APPLSETTINGS
*"* do not include other source files here!!!

  constants _VERSION_ type I value 16. "#EC NOTEXT
...
CLASS CL_ISH_SHA_APPLSETTINGS IMPLEMENTATION.
...
method ATTACH_FOR_READ.
  ...
  DATA:
    ...
    l_client_supplied  TYPE abap_bool. "#EC *
