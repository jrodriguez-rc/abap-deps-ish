class CX_ISHMED_TC_CUST definition
  public
...
CLASS CX_ISHMED_TC_CUST IMPLEMENTATION.
...
if textid is initial.
  IF_T100_MESSAGE~T100KEY = CX_ISHMED_TC_CUST .
else.
