*"* components of interface IF_ISH_GUI_DOCKCONT_VIEW
interface IF_ISH_GUI_DOCKCONT_VIEW
  public .
  ...
  methods GET_DOCKCONT_LAYOUT
    returning
      value(RR_DOCKCONT_LAYOUT) type ref to CL_ISH_GUI_DOCKCONT_LAYOUT .
  methods GET_DOCKING_CONTAINER
    returning
      value(RR_DOCKING_CONTAINER) type ref to CL_GUI_DOCKING_CONTAINER .
