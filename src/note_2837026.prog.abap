...
* Generated by SAP_LOCAL_DOWNPORT_ASSISTANT Version 7.32 on 20.09.2019 with option ALL

* The individual coding starts at 'FORM update_01.' ( line 3.697 )
...
FORM update_01. " TABD RN1STATUS_TXT ( DE , source: EV8 )
  ...
  CALL METHOD lcl_wb=>create_table     "#EC *
    EXPORTING
      i_tabname    = 'RN1STATUS_TXT'
      i_devclass   = 'N1BASE'
      i_exclass    = '2'
      i_authclass  = '00'
      i_masterlang = 'D'
      i_langu      = 'D'
      i_ddtext     = 'IS-H: Statusschema + Anwenderstatus (inkl. Text)'.
  ...
  CALL METHOD lcl_wb=>add_field_to_table    "#EC *
    EXPORTING
      i_tabname    = 'RN1STATUS_TXT'
      i_fieldname  = '.INCLUDE'
      i_rollname   = 'RN1STATUS'
      i_context    = 'RN1STATUS_TXT'.
  ...
  CALL METHOD lcl_wb=>add_field_to_table    "#EC *
    EXPORTING
      ...
      i_fieldname  = 'STONR'
      i_rollname   = 'J_STONR'
      i_context    = '.INCLUDE RN1STATUS'.

  CLEAR: ls_dd08v, lt_dd05m.
  CALL METHOD lcl_wb=>add_field_to_table    "#EC *
    EXPORTING
      i_tabname    = 'RN1STATUS_TXT'
      i_fieldname  = 'STSMA_TXT'
      i_rollname   = 'TEXT30'
      i_context    = 'STONR'.
  ...
  CALL METHOD lcl_wb=>add_field_to_table    "#EC *
    EXPORTING
      i_tabname    = 'RN1STATUS_TXT'
      i_fieldname  = 'ESTAT_TXT30'
      i_rollname   = 'J_TXT30'
      i_context    = 'ESTAT_TXT04'.
...
FORM update.
  ...
  gv_objects_with_snote_check = 'TABD'.  "#EC NOTEXT

  APPEND 'RN1STATUS_TXT'                          TO gt_tabname.   "#EC NOTEXT

  PERFORM update_01. " TABD RN1STATUS_TXT ( DE , source: EV8 )
