...
* Generated by SAP_LOCAL_DOWNPORT_ASSISTANT Version 7.29 on 14.06.2019 with option ALL

* The individual coding starts at 'FORM update_01.' ( line 3.514 )
...
FORM update_02. " DOCU TXISHMED_N1ORGPAR_N1MEDOUNCH ( DE , source: EV8 )
  CALL METHOD lcl_wb=>create_other_docu     "#EC *
    EXPORTING
      i_devclass  = 'N1BASE'
      i_docname   = 'TXISHMED_N1ORGPAR_N1MEDOUNCH'
      i_langu     = 'D'
      i_line      =:'*  <ZH>Medikation: Dosis löschen bei Einheitenwechsel</>',                                    "#EC NOTEXT
                    '*',                                                                                           "#EC NOTEXT
                    'U1 DEFINITION',                                                                               "#EC NOTEXT
                    '*  Mit diesem Parameter können Sie definieren, ob das System in Smart',                       "#EC NOTEXT
                    '   Medication nach Wechsel der Dosiseinheit die Dosismenge neu berechnet',                    "#EC NOTEXT
                    '   oder diese auf Null zurücksetzt.',                                                         "#EC NOTEXT
                    '*',                                                                                           "#EC NOTEXT
                    'U1 VERWENDUNG',                                                                               "#EC NOTEXT
                    '*  Mögliche Parameterwerte:',                                                                 "#EC NOTEXT
                    '*  <ZH>'' ''</> :  Wenn Sie für den Parameter keinen Wert setzen, berechnet',                 "#EC NOTEXT
                    '   das System die Dosis erneut, nachdem die Dosiseinheit gewechselt wurde.',                  "#EC NOTEXT
                    '*  X :  Wenn Sie für den Parameter diesen Wert setzen, setzt das System die',                 "#EC NOTEXT
                    '   Dosis auf Null zurück, nachdem die  Dosiseinheit gewechselt wurde.',                       "#EC NOTEXT
                    '*',                                                                                           "#EC NOTEXT
                    space.
ENDFORM.
...
FORM update.
  ...
  PERFORM update_02. " DOCU TXISHMED_N1ORGPAR_N1MEDOUNCH ( DE , source: EV8 )
