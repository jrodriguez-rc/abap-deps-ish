*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_V_TN1TC_TIMES_OU
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_V_TN1TC_TIMES_OU    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_V_TN1TC_TIMES_OU'
         EXPORTING
              FCODE          = READ
...
EXTRACT = V_TN1TC_TIMES_OU_EXTRACT
TOTAL = V_TN1TC_TIMES_OU_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_V_TN1TC_TIMES_OU'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_V_TN1TC_TIMES_OU-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = V_TN1TC_TIMES_OU_EXTRACT
TOTAL = V_TN1TC_TIMES_OU_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_V_TN1TC_TIMES_OU-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_V_TN1TC_TIMES_OU'
...
TOTAL = V_TN1TC_TIMES_OU_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_V_TN1TC_TIMES_OU-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_V_TN1TC_TIMES_OU-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_V_TN1TC_TIMES_OU'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_V_TN1TC_TIMES_OU-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = V_TN1TC_TIMES_OU_EXTRACT
TOTAL = V_TN1TC_TIMES_OU_TOTAL
