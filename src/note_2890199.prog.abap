...
* Generated by SAP_LOCAL_DOWNPORT_ASSISTANT Version 7.45 on 27.03.2020 with option ALL

* The individual coding starts at 'FORM update_01.' ( line 6.245 )
...
FORM update_02. " DTED N1TC_ALTERNATIV_MATRIX ( DE , source: EV8 )
  CALL METHOD lcl_wb=>create_dtel    "#EC *
    EXPORTING
      i_rollname   = 'N1TC_ALTERNATIV_MATRIX'
      i_devclass   = 'N1BASE'
      i_domname    = 'XFELD'
      i_headlen    = '55'
      i_scrlen1    = '10'
      ...
      i_masterlang = 'D'
      i_langu      = 'D'
      i_ddtext     = 'Alternative Matrix der OE-Konstellation erstellen'
      i_reptext    = 'alternative OE-Konstellation'
      i_scrtext_s  = 'a.OEKonst.'
      i_scrtext_m  = 'alt. OE-Konst.'
      i_scrtext_l  = 'alternative OE-Konstellation'.
ENDFORM.

FORM update_03. " DOCU DEN1TC_ALTERNATIV_MATRIX ( DE , source: EV8 )
  CALL METHOD lcl_wb=>create_dtel_docu     "#EC *
    EXPORTING
      ...
      i_line      =:'U1 &DEFINITION&',                                                                             "#EC NOTEXT
                    'AS Gibt an, dass die OE-Konstellation innerhalb der OE-Zuständigkeit nicht',                  "#EC NOTEXT
                    '   aufgelöst wird, wenn in den beiden Feldern <LS>FachOE</> und',                             "#EC NOTEXT
                    '   <LS>BehPflOE</> der Wert <LB>*</> eingegeben wurde.',                                      "#EC NOTEXT
                    'AS',                                                                                          "#EC NOTEXT
                    'U1 &USE&',                                                                                    "#EC NOTEXT
                    'AS Wenn Sie dieses Kennzeichen markieren, zieht das System für die Prüfung',                  "#EC NOTEXT
                    '   auf den Behandlungsauftrag alle in der Einrichtung vorhandenen OE heran.',                 "#EC NOTEXT
                    '   Das System prüft dabei nicht, ob die OE aktuell aktiv sind oder eine',                     "#EC NOTEXT
                    '   Nachlauf- und Beantragungsfrist eingerichtet wurde.',                                      "#EC NOTEXT
...
FORM update_04. " DTED N1TC_SECURITY_LEVEL ( DE , source: EV8 )
  CALL METHOD lcl_wb=>create_dtel    "#EC *
    EXPORTING
      i_rollname   = 'N1TC_SECURITY_LEVEL'
      i_devclass   = 'N1BASE'
      i_domname    = 'N1TC_SECURITY_LEVEL'
      i_headlen    = '55'
      i_scrlen1    = '10'
      i_scrlen2    = '14'
      i_scrlen3    = '20'
      ...
      i_masterlang = 'D'
      i_langu      = 'D'
      i_ddtext     = 'Behandlungsauftrag Sicherheitsstufe'
      i_reptext    = 'Sicherheitsstufe'
      i_scrtext_s  = 'SicherhSt.'
      i_scrtext_m  = 'SicherhStufe'
      i_scrtext_l  = 'Sicherheitsstufe'.
ENDFORM.

FORM update_05. " TABD TN1TC_GLOB_SET ( DE , source: EV8 )
  ...
  CALL METHOD lcl_wb=>add_field_to_table    "#EC *
    EXPORTING
      i_tabname    = 'TN1TC_GLOB_SET'
      i_fieldname  = 'INACTIVE_DAYS'
      i_rollname   = 'N1TC_INACTIVE_DAYS'
      i_context    = 'NO_CLEAR_BUFFER'.

  CLEAR: ls_dd08v, lt_dd05m.
  CALL METHOD lcl_wb=>add_field_to_table    "#EC *
    EXPORTING
      i_tabname    = 'TN1TC_GLOB_SET'
      i_fieldname  = 'ALTERNATIV_MATRIX'
      i_rollname   = 'N1TC_ALTERNATIV_MATRIX'
      i_context    = 'INACTIVE_DAYS'.

ENDFORM.

FORM update_06. " VIED V_TN1TC_GLOB_SET ( DE , source: EV8 )
...
FORM update_07. " REPT SAPL0N1TC ( DE , source: EV8 )
  CALL METHOD lcl_wb=>create_program_text    "#EC *
    EXPORTING
      ...
      i_id         = 'I'
      i_key        = '002'
      i_text       = 'Bezugsebene "Sonderzugriff" ist nicht zulässig'  "#EC NOTEXT
      i_length     = '92'.

ENDFORM.

FORM update_08_0100. " TOBJ V_TN1TC_GLOB_SET ( DE EV8 )
  ...
  ls_rpy_dyhead-descript       = 'Viewpflege: Übersichtsbild V_TN1TC_GLOB_SET' ##STRING_OK.                     "#EC NOTEXT
  ...
  ls_rpy_dyfatc-text             = 'Sicherheitsstufe________________________'.                      "#EC NOTEXT
  ls_rpy_dyfatc-line             = '001'.                                                           "#EC NOTEXT
  ...
  ls_rpy_dyfatc-cont_name        = 'TCTRL_V_TN1TC_GLOB_SET'.                                        "#EC NOTEXT
  ls_rpy_dyfatc-type             = 'TEXT'.                                                          "#EC NOTEXT
  ls_rpy_dyfatc-name             = '*V_TN1TC_GLOB_SET-INACTIVE_DAYS'.                               "#EC NOTEXT
  ls_rpy_dyfatc-text             = 'Inaktive_T______________________________'.                      "#EC NOTEXT
  ls_rpy_dyfatc-line             = '001'.                                                           "#EC NOTEXT
  ...
  ls_rpy_dyfatc-cont_name        = 'TCTRL_V_TN1TC_GLOB_SET'.                                        "#EC NOTEXT
  ls_rpy_dyfatc-type             = 'TEXT'.                                                          "#EC NOTEXT
  ls_rpy_dyfatc-name             = '*V_TN1TC_GLOB_SET-ALTERNATIV_MATRIX'.                           "#EC NOTEXT
  ls_rpy_dyfatc-text             = 'a.OEKonst.______________________________'.                      "#EC NOTEXT
  ls_rpy_dyfatc-line             = '001'.                                                           "#EC NOTEXT
  ...
  ls_rpy_dyfatc-type             = 'TEMPLATE'.                                                      "#EC NOTEXT
  ls_rpy_dyfatc-name             = 'V_TN1TC_GLOB_SET-INACTIVE_DAYS'.                                "#EC NOTEXT
  ls_rpy_dyfatc-text             = '______'.                                                        "#EC NOTEXT
  ls_rpy_dyfatc-line             = '001'.                                                           "#EC NOTEXT
  ls_rpy_dyfatc-column           = '006'.                                                           "#EC NOTEXT
  ls_rpy_dyfatc-length           = '006'.                                                           "#EC NOTEXT
  ls_rpy_dyfatc-vislength        = '010'.                                                           "#EC NOTEXT
  ls_rpy_dyfatc-height           = '001'.                                                           "#EC NOTEXT
  ls_rpy_dyfatc-format           = 'INT2'.                                                          "#EC NOTEXT
  ls_rpy_dyfatc-from_dict        = 'X'.                                                             "#EC NOTEXT
  ls_rpy_dyfatc-modific          = 'X'.                                                             "#EC NOTEXT
  ls_rpy_dyfatc-foreignkey       = 'X'.                                                             "#EC NOTEXT
  ls_rpy_dyfatc-input_fld        = 'X'.                                                             "#EC NOTEXT
  ...
  DATA: ls_rpy_dypara TYPE rpy_dypara, lt_rpy_dypara TYPE TABLE OF rpy_dypara.
    ...
    APPEND '    FIELD V_TN1TC_GLOB_SET-INACTIVE_DAYS .'                                   TO lt_d022s. "#EC NOTEXT
    APPEND '    FIELD V_TN1TC_GLOB_SET-ALTERNATIV_MATRIX .'                               TO lt_d022s. "#EC NOTEXT
...
FORM update_08. " TOBJ V_TN1TC_GLOB_SETV ( DE , source: EV8 )
  IF lcl_wb=>generate_maint_view(  "#EC *
      ...
      i_auth_group   = 'NC'
      i_func_group   = '0N1TC'
      i_dynp_list    = '0100') EQ 'I'. "Insert
     PERFORM update_08_0100.
  ENDIF.
...
FORM update_09. " TABU TVIMF ( DE , source: EV8 )
...
FORM update_10. " DSYS SIMGISH_TN1TC_GLOB_SET ( DE , source: EV8 )
  CALL METHOD lcl_wb=>create_other_docu     "#EC *
    EXPORTING
      ...
      i_line      =:'UT <ZH>&USE&</>',                                                                             "#EC NOTEXT
                    'AS In dieser Customizing-Aktivität legen Sie folgende Einstellungen pro',                     "#EC NOTEXT
                    ...
                    '   eine Performance-Optimierung legen Sie mit der Eingabe der Verfallszeit',                  "#EC NOTEXT
                    ...
                    '   für eine Einrichtung. Gebn Sie im Feld <LS>Verfallszeiten</> die',                         "#EC NOTEXT
                    ...
                    'AS Geben Sie in der Spalte <LS>Inaktive T</> (<LS>Inaktive Tage</>) die',                     "#EC NOTEXT
                    '   Anzahl der vergangenen Tage ein, für die nicht mehr aktive (geschlossene',                 "#EC NOTEXT
                    ...
                    'AS Mit dem Kennzeichen <LS>a.OEKonst.</> können Sie für die',                                 "#EC NOTEXT
                    '   OE-Zuständigkeiten steuern, dass das System alle OE der Einrichtung',                      "#EC NOTEXT
                    '   unabhängig von ihrer aktuellen Gültigkeit berücksichtigen soll. Das',                      "#EC NOTEXT
                    '   System verwendet das Kennzeichen nur, wenn Sie im Customizing der',                        "#EC NOTEXT
                    '   <DS:SIMG.ISH_TN1TC_OU_RESP_OU>OE-Konstellation innerhalb der',                             "#EC NOTEXT
                    '   OE-Zuständigkeit</> in den Feldern <LS>FachOE </> und <LS>BehPflO</> den',                 "#EC NOTEXT
                    '   Wert <LB>*</> eingegeben haben.',                                                          "#EC NOTEXT
...
FORM genview.
  ...
  PERFORM update_08. " TOBJ V_TN1TC_GLOB_SETV ( DE , source: EV8 )
ENDFORM.

FORM update.

  gv_master_languages   = 'D'.  "#EC NOTEXT
  gv_objects_with_snote_check = 'FUGR,DTED,TABD,REPT'.  "#EC NOTEXT
  ...
  PERFORM update_02. " DTED N1TC_ALTERNATIV_MATRIX ( DE , source: EV8 )
  PERFORM update_03. " DOCU DEN1TC_ALTERNATIV_MATRIX ( DE , source: EV8 )
  PERFORM update_04. " DTED N1TC_SECURITY_LEVEL ( DE , source: EV8 )
  PERFORM update_05. " TABD TN1TC_GLOB_SET ( DE , source: EV8 )
  PERFORM update_06. " VIED V_TN1TC_GLOB_SET ( DE , source: EV8 )
  PERFORM update_07. " REPT SAPL0N1TC ( DE , source: EV8 )
  PERFORM update_08. " TOBJ V_TN1TC_GLOB_SETV ( DE , source: EV8 )
  PERFORM update_09. " TABU TVIMF ( DE , source: EV8 )
  PERFORM update_10. " DSYS SIMGISH_TN1TC_GLOB_SET ( DE , source: EV8 )
