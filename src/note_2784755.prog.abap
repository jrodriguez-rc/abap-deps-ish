...
* Generated by SAP_LOCAL_DOWNPORT_ASSISTANT Version 7.29 on 11.06.2019 with option ALL

* The individual coding starts at 'FORM update_01.' ( line 3.088 )
...
FORM update_01. " REPT SAPLN1TC_DIALOG ( DE , source: EV8 )
  CALL METHOD lcl_wb=>create_program_text    "#EC *
    EXPORTING
      i_progname   = 'SAPLN1TC_DIALOG'
      i_devclass   = 'N1BASE'
      i_masterlang = 'D'
      i_langu      = 'D':
      i_id         = 'I'
      i_key        = '100'
      i_text       = 'Beantragung auf Grund eines Notfalls'  "#EC NOTEXT
      i_length     = '72',

      i_id         = 'I'
      i_key        = '101'
      i_text       = 'Aufgrund der für den Benutzer konfigurierten Zuständigkeit haben Sie für diesen Patienten keinen Behandlungsauftrag.'  "#EC NOTEXT
      i_length     = '116',

      i_id         = 'I'
      i_key        = '102'
      i_text       = 'Der Behandlungsauftrag kann temporär für den aktuellen Tag beantragt werden. Dieser Zugriff wird gesondert geloggt.'  "#EC NOTEXT
      i_length     = '115',

      i_id         = 'I'
      i_key        = '103'
      i_text       = 'Sonderzugriff'  "#EC NOTEXT
      i_length     = '72'.
...
FORM update.
  ...
  PERFORM update_01. " REPT SAPLN1TC_DIALOG ( DE , source: EV8 )
