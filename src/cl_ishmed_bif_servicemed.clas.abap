class CL_ISHMED_BIF_SERVICEMED definition
  public
  final
  create public .

*"* public components of class CL_ISHMED_BIF_SERVICEMED
...
protected section.
*"* protected components of class CL_ISHMED_BIF_SERVICEMED
*"* do not include other source files here!!!
private section.
*"* private components of class CL_ISHMED_BIF_SERVICEMED
*"* do not include other source files here!!!
ENDCLASS.



CLASS CL_ISHMED_BIF_SERVICEMED IMPLEMENTATION.
