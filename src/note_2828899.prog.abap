...
* Generated by SAP_LOCAL_DOWNPORT_ASSISTANT Version 7.32 on 23.08.2019 with option ALL

* The individual coding starts at 'FORM update_01.' ( line 3.322 )
...
FORM update_01. " MESS N1TC020 ( DE , source: EV8 )
  CALL METHOD lcl_wb=>create_message     "#EC *
    EXPORTING
      ...
      i_text       = 'Eine temporäre Beantragung für vorläufige Patienten ist nicht möglich'.
...
FORM update.
  ...
  PERFORM update_01. " MESS N1TC020 ( DE , source: EV8 )
