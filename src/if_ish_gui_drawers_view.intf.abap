*"* components of interface IF_ISH_GUI_DRAWERS_VIEW
interface IF_ISH_GUI_DRAWERS_VIEW
  public .
  ...
  methods DISABLE_DRAWER
    importing
      !I_DRAWER_NAME type N1GUI_ELEMENT_NAME
    raising
      CX_ISH_STATIC_HANDLER .
  methods ENABLE_DRAWER
    importing
      !I_DRAWER_NAME type N1GUI_ELEMENT_NAME
    raising
      CX_ISH_STATIC_HANDLER .
  methods GET_OPEN_DRAWER_NAME
    returning
      value(R_OPEN_DRAWER_NAME) type N1GUI_ELEMENT_NAME .
  methods GET_OPEN_VIEW
    returning
      value(RR_OPEN_VIEW) type ref to IF_ISH_GUI_CONTROL_VIEW .
  methods OPEN_DRAWER_BY_NAME
    importing
      !I_DRAWER_NAME type N1GUI_ELEMENT_NAME
    raising
      CX_ISH_STATIC_HANDLER .
