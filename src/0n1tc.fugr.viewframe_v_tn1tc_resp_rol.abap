*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_V_TN1TC_RESP_ROL
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_V_TN1TC_RESP_ROL    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_V_TN1TC_RESP_ROL'
         EXPORTING
              FCODE          = READ
...
EXTRACT = V_TN1TC_RESP_ROL_EXTRACT
TOTAL = V_TN1TC_RESP_ROL_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_V_TN1TC_RESP_ROL'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_V_TN1TC_RESP_ROL-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = V_TN1TC_RESP_ROL_EXTRACT
TOTAL = V_TN1TC_RESP_ROL_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_V_TN1TC_RESP_ROL-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_V_TN1TC_RESP_ROL'
...
TOTAL = V_TN1TC_RESP_ROL_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_V_TN1TC_RESP_ROL-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_V_TN1TC_RESP_ROL-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_V_TN1TC_RESP_ROL'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_V_TN1TC_RESP_ROL-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = V_TN1TC_RESP_ROL_EXTRACT
TOTAL = V_TN1TC_RESP_ROL_TOTAL
