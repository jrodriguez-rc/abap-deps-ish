class CX_ISH_NO_CHECK_HANDLER definition
  public
  inheriting from CX_NO_CHECK
  create public .

*"* public components of class CX_ISH_NO_CHECK_HANDLER
*"* do not include other source files here!!!
public section.

  data GR_ERRORHANDLER type ref to CL_ISHMED_ERRORHANDLING read-only .
  data GR_MSGTYP type SY-MSGTY value 'E' .
...
protected section.
*"* protected components of class CX_ISH_NO_CHECK_HANDLER
*"* do not include other source files here!!!
private section.
*"* private components of class CX_ISH_NO_CHECK_HANDLER
*"* do not include other source files here!!!
ENDCLASS.



CLASS CX_ISH_NO_CHECK_HANDLER IMPLEMENTATION.
