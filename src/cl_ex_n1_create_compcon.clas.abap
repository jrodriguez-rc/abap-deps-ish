class CL_EX_N1_CREATE_COMPCON definition
  public
  final
  create public .

*"* public components of class CL_EX_N1_CREATE_COMPCON
*"* do not include other source files here!!!
public section.

  interfaces IF_EX_N1_CREATE_COMPCON .

  constants VERSION type VERSION value 000001. "#EC NOTEXT
  type-pools SXRT .
protected section.
*"* protected components of class CL_EX_N1_CREATE_COMPCON
*"* do not include other source files here!!!
private section.
*"* private components of class CL_EX_N1_CREATE_COMPCON
*"* do not include other source files here!!!
...
CLASS CL_EX_N1_CREATE_COMPCON IMPLEMENTATION.


method IF_EX_N1_CREATE_COMPCON~CREATE_COMPCON.
  CLASS CL_EXIT_MASTER DEFINITION LOAD.
  DATA: EXIT_OBJ_TAB TYPE SXRT_EXIT_TAB.

  DATA: exitintf TYPE REF TO IF_EX_N1_CREATE_COMPCON,
  ...
  IF sy-subrc NE 0.
    ...
    <flt_cache_line>-method_name = 'CREATE_COMPCON'.
        ...
        CALL METHOD CL_EXIT_MASTER=>CREATE_OBJ_BY_INTERFACE_FILTER
           EXPORTING
              CALLER       = me
              INTER_NAME   = 'IF_EX_N1_CREATE_COMPCON'
              METHOD_NAME  = 'CREATE_COMPCON'
  ...
  IF <flt_cache_line>-valid = sxrt_true.
    ...
    CALL FUNCTION 'PF_ASTAT_OPEN'
       EXPORTING
           OPENKEY = 'GPIR1XMYMEBX00002X5DlW'
           TYP     = 'UE'.
    ...
    CASE <flt_cache_line>-imp_switch.
      WHEN 'VSR'.
        ...
        IF <flt_cache_line>-eo_object is initial.
          CALL METHOD ('CL_FOBU_METHOD_EVALUATION')=>load
               EXPORTING
                  ...
                  im_interface_name = 'IF_EX_N1_CREATE_COMPCON'
                  im_method_name    = 'CREATE_COMPCON'
               RECEIVING
        ...
        CLEAR data_ref.
        GET REFERENCE OF IR_COMPONENT INTO data_ref.
        CALL METHOD <flt_cache_line>-eo_object->set_parameter(
            im_parmname = 'IR_COMPONENT'
            im_value    = data_ref ).
        ...
        CLEAR data_ref.
        GET REFERENCE OF ER_COMPCON INTO data_ref.
        CALL METHOD <flt_cache_line>-eo_object->set_parameter(
            im_parmname = 'ER_COMPCON'
            im_value    = data_ref ).
      ...
      WHEN OTHERS.
        ...
        CALL METHOD EXITINTF->CREATE_COMPCON
           EXPORTING
