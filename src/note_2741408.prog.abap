...
* Generated by SAP_LOCAL_DOWNPORT_ASSISTANT Version 7.29 on 13.06.2019 with option ALL

* The individual coding starts at 'FORM update_01.' ( line 6.528 )
...
FORM update_02. " DOMD N1TC_INACTIVE_DAYS ( DE , source: EV8 )
  CALL METHOD lcl_wb=>create_doma   "#EC *
    EXPORTING
      i_domname    = 'N1TC_INACTIVE_DAYS'
      i_devclass   = 'N1BASE'
      i_datatype   = 'INT2'
      i_outputlen  = '000006'
      i_masterlang = 'D'
      i_langu      = 'D'
      i_ddtext     = 'Inaktive Tage, mit denen OEs weiterhin berücksichtig werden'
      i_leng       = '000005':
...
FORM update_03. " DTED N1TC_INACTIVE_DAYS ( DE , source: EV8 )
  CALL METHOD lcl_wb=>create_dtel    "#EC *
    EXPORTING
      ...
      i_langu      = 'D'
      i_ddtext     = 'Inaktive Tage, mit denen OEs weiterhin berücksichtig werden'
      i_reptext    = 'Inaktive Tage'
      i_scrtext_s  = 'Inaktive T'
      i_scrtext_m  = 'Inaktive Tage'
      i_scrtext_l  = 'Inaktive Tage'.
ENDFORM.

FORM update_04. " DOCU DEN1TC_INACTIVE_DAYS ( DE , source: EV8 )
  CALL METHOD lcl_wb=>create_dtel_docu     "#EC *
    EXPORTING
      ...
      i_line      =:'U1 &DEFINITION&',                                                                             "#EC NOTEXT
                    'AS Dieser Wert als Angabe in Tagen bestimmt, inwieweit zurückliegende',                       "#EC NOTEXT
                    '   Änderungen an der Organisationsstruktur des Krankenhauses (Schließen bzw',                 "#EC NOTEXT
                    '   Stornieren von OEs) beim Aufbau der Zuständigkeitsmatrix berücksichtigt',                  "#EC NOTEXT
                    '   werden.',                                                                                  "#EC NOTEXT
                    'U1 &USE&',                                                                                    "#EC NOTEXT
                    'AS Dieser Wert kann im Einführungsleitfaden (IMG) unter Branchenlösung',                      "#EC NOTEXT
                    '   Krankenhaus->Werkzeuge-> Behandlungsauftrag->Allgemeine Einstellungen',                    "#EC NOTEXT
                    '   definiert bzw. geändert werden."',                                                         "#EC NOTEXT
...
FORM update.
  ...
  gv_objects_with_snote_check = 'DOMD,DTED,TABD'.  "#EC NOTEXT
  ...
  PERFORM update_02. " DOMD N1TC_INACTIVE_DAYS ( DE , source: EV8 )
  PERFORM update_03. " DTED N1TC_INACTIVE_DAYS ( DE , source: EV8 )
  PERFORM update_04. " DOCU DEN1TC_INACTIVE_DAYS ( DE , source: EV8 )
