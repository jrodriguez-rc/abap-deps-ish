class CL_ISH_GUI_DRAWERS_LAYOUT definition
  public
  inheriting from CL_ISH_GUI_CONTAINER_LAYOUT
  create public .

*"* public components of class CL_ISH_GUI_DRAWERS_LAYOUT
...
protected section.
*"* protected components of class CL_ISH_GUI_DRAWERS_LAYOUT
*"* do not include other source files here!!!
private section.
...
CLASS CL_ISH_GUI_DRAWERS_LAYOUT IMPLEMENTATION.
