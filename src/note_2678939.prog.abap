...
* The individual coding starts at 'FORM update_01.' ( line 3.642 )
...
FORM update_02. " REPT L0N1SFXX ( DE , source: EV8 )
  CALL METHOD lcl_wb=>create_program_text    "#EC *
    EXPORTING
      ...
      i_id         = 'R'
      i_key        = ''
      i_text       = 'IS-H*MED: Include für Prüfungen und F4-Hilfen des OE-Customizings'  "#EC NOTEXT
      i_length     = '65'.

ENDFORM.

FORM update_03. " DOCU TXISHMED_N1ORGPAR_N1MEMARHTM ( DE , source: EV8 )
  CALL METHOD lcl_wb=>create_other_docu     "#EC *
    EXPORTING
      i_devclass  = 'NMED_ME'
      i_docname   = 'TXISHMED_N1ORGPAR_N1MEMARHTM'
      i_langu     = 'D'
      i_line      =:'U1 Medikation: eMAR HTML-Kopfdaten',                                                          "#EC NOTEXT
                    'U1 DEFINITION',                                                                               "#EC NOTEXT
                    '*  Mit diesem Parameter können Sie die eMAR HTML-Kopfdaten aktivieren bzw.',                  "#EC NOTEXT
                    '   deaktivieren.',                                                                            "#EC NOTEXT
                    '*  Der Parameter gilt für alle Organisationseinheiten, welche die Funktion',                  "#EC NOTEXT
                    '   <ZK>eMAR-Dokumentation</> verwenden.',                                                     "#EC NOTEXT
                    '*  Bitte beachten Sie, dass der HTML-Kopfbereich nicht bei der',                              "#EC NOTEXT
                    ...
                    '*',                                                                                           "#EC NOTEXT
                    'U1 VERWENDUNG',                                                                               "#EC NOTEXT
                    '*  Mögliche Parameterwerte:',                                                                 "#EC NOTEXT
                    'B1 '' '' :  eMAR HTML-Kopfdaten deaktivieren',                                                "#EC NOTEXT
                    'B1 X :  eMAR HTML-Kopfdaten aktivieren',                                                      "#EC NOTEXT
                    '*',                                                                                           "#EC NOTEXT
                    space.
ENDFORM.

FORM update_04. " DOCU TXISHMED_N1ORGPAR_N1METSPAN ( DE , source: EV8 )
  CALL METHOD lcl_wb=>create_other_docu     "#EC *
    EXPORTING
      i_devclass  = 'NMED_ME'
      i_docname   = 'TXISHMED_N1ORGPAR_N1METSPAN'
      i_langu     = 'D'
      i_line      =:'U1 Medikation: Zeitspanne in Minuten festlegen',                                              "#EC NOTEXT
                    'U1 DEFINITION',                                                                               "#EC NOTEXT
                    '*  Mit diesem Parameter können Sie die Zeitspanne (Minuten) definieren, die',                 "#EC NOTEXT
                    '   von den eMAR-Aktivitäten zum Aktualisieren benötigt wird.',                                "#EC NOTEXT
                    '*  Infolge dieser Aktualisierung ändert sich die Anzeige der Ampelsymbole',                   "#EC NOTEXT
                    '   in der Spalte <ZK>eMAR-Aktivität</> der entsprechenden Sichttypen.',                       "#EC NOTEXT
                    '*  Der Parameter gilt für eMAR-Aktivitäten, wie z.B. Flussrate ändern,',                      "#EC NOTEXT
                    '   Infusion abhängen, usw.',                                                                  "#EC NOTEXT
                    '*  Der Standardwert beträgt 15 min.. Bitte beachten Sie, dass ein',                           "#EC NOTEXT
                    '   wesentlich höherer Wert Auswirkungen auf die Performance haben kann.',                     "#EC NOTEXT
                    '*  Das System prüft den Parameterwert in der folgenden Reihenfolge',                          "#EC NOTEXT
                    'B1 Dokumentierende pflegerische OE',                                                          "#EC NOTEXT
                    'B1 Dokumentierende fachliche OE',                                                             "#EC NOTEXT
                    'B1 Alle Organisationseinheiten (*)',                                                          "#EC NOTEXT
                    ...
                    'U1 VERWENDUNG',                                                                               "#EC NOTEXT
                    '*  Mögliche Parameterwerte:',                                                                 "#EC NOTEXT
                    'B1 Nummer ohne Dezimalstellen',                                                               "#EC NOTEXT
                    space.
ENDFORM.
...
FORM update.
  ...
  PERFORM update_02. " REPT L0N1SFXX ( DE , source: EV8 )
  PERFORM update_03. " DOCU TXISHMED_N1ORGPAR_N1MEMARHTM ( DE , source: EV8 )
  PERFORM update_04. " DOCU TXISHMED_N1ORGPAR_N1METSPAN ( DE , source: EV8 )
